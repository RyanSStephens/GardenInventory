...
const seedPlants = async () => {
  ...
  const plants = [
    ...
    },
    {
      ...
      expectedHarvestDate: new Date('2020-06-01'),
    ...
    },
    {
      ...
      expectedHarvestDate: new Date('2020-05-15'),
      harvestDate: new Date('2020-05-12'),
    ...
    },
    {
      ...
      expectedHarvestDate: new Date('2020-09-01'),
    ...
    },
    {
      ...
      category: 'vegetables',
      status: 'flowering',
      plantedDate: new Date('2020-05-20'),
      expectedHarvestDate: new Date('2020-07-10'),
    ...
    },
    {
      ...
      category: 'flowers',
      status: 'flowering',
      plantedDate: new Date('2020-04-25'),
      expectedHarvestDate: new Date('2020-10-15'),
    ...
    },
    {
      ...
      category: 'vegetables',
      status: 'growing',
      plantedDate: new Date('2020-04-01'),
      expectedHarvestDate: new Date('2020-07-01'),
...
const seedHarvests = async (plants) => {
  ...
  const harvests = [
    ...
    },
    {
      ...
      harvestDate: new Date('2020-06-01'),
      quantity: 2,
      unit: 'cups',
      weight: 0.5,
      quality: 'good',
    ...
    {
      plant: plants.find(p => p.name === 'Basil')?._id,
      harvestDate: new Date('2020-06-15'),
      quantity: 1.5,
      unit: 'cups',
      weight: 0.3,
      quality: 'excellent',
...
const additionalPlants = [
  {
    ...
    variety: 'Sweet 100',
    category: 'vegetable',
    plantingDate: new Date('2021-03-15'),
    expectedHarvestDate: new Date('2021-06-15'),
  ...
  },
  {
    ...
    variety: 'Buttercrunch',
    category: 'vegetable',
    plantingDate: new Date('2021-02-20'),
    expectedHarvestDate: new Date('2021-04-20'),
    location: 'Cold Frame',
  ...
  },
  {
    ...
    variety: 'Dark Opal',
    category: 'herb',
    plantingDate: new Date('2021-04-01'),
    expectedHarvestDate: new Date('2021-05-15'),
  ...
  },
  {
    ...
    category: 'flower',
    plantingDate: new Date('2021-04-10'),
    expectedHarvestDate: new Date('2021-08-15'),
    location: 'Back Fence',
    status: 'growing',
  ...
  },
  {
    ...
    category: 'vegetable',
    plantingDate: new Date('2021-04-20'),
    expectedHarvestDate: new Date('2021-06-20'),
...
const additionalInventory = [
  {
    ...
    expirationDate: new Date('2023-02-15'),
...
const additionalHarvests = [
  {
    ...
    harvestDate: new Date('2021-03-10'),
    quantity: 2.5,
    unit: 'lbs',
    quality: 'excellent',
  ...
  {
    plant: null, // Will be populated with actual plant ID
    harvestDate: new Date('2021-02-28'),
    quantity: 1.2,
    unit: 'lbs',
    quality: 'good',
  ...
  {
    plant: null, // Will be populated with actual plant ID
    harvestDate: new Date('2021-03-20'),
    quantity: 0.5,
    unit: 'lbs',
    quality: 'excellent',
